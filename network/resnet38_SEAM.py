...
class Net_for_cityspace(network.resnet38d.Net):
    def __init__(self):
        super(Net_for_cityspace, self).__init__()
        self.dropout7 = torch.nn.Dropout2d(0.5)

        self.fc8 = nn.Conv2d(4096, 5, 1, bias=False)
...
class Net_for_coco(network.resnet38d.Net):
    def __init__(self, classes=80):
        super(Net_for_coco, self).__init__()
        self.dropout7 = torch.nn.Dropout2d(0.5)
